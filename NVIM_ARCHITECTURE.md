...
- **插件分类**:
  ...
  - **导航搜索** (3个): telescope, fzf, yazi
  - **语言支持** (4个): markdown, lua
  - **实用工具** (5个): autocomplete, csv
- **特性**: 延迟加载、条件加载、依赖管理
...
### 插件管理架构: 统一化配置
- **主配置文件**: `lua/config/plugins.lua` (38 个插件的统一管理)
...
#### 🧭 导航搜索插件 (3个)
- **telescope**: telescope.nvim 模糊搜索核心（集成命令搜索）
- **fzf**: fzf.vim 高性能搜索
