" nnoremap \t :tabe<CR>:-tabmove<CR>:term sh -c 'open -a warp .'<CR><C-\><C-N>:q<CR>
...
nnoremap <LEADER>rv :e $HOME/.config/nvim/init.vim<CR>
nnoremap <LEADER>rz :e $HOME/.zshrc<CR>
nnoremap <LEADER>ro :e $HOME/Library/Mobile Documents/iCloud~md~obsidian/Documents/Tianli_brain/.obsidian.vimrc<CR>
...
source $HOME/.config/nvim/cursorm.vim
...
noremap <M-K> :res -5<CR>
noremap <M-J> :res +5<CR>
...
noremap <leader>tK :tab split<CR>
...
noremap <LEADER>dc :call AddLineNumbers()<CR>
...
nnoremap <LEADER>d :call Show_documentation()<CR>
...
nmap <leader>ep :CocCommand explorer<CR>
...
" ==================== Undotree ====================
"
noremap <leader>tr :UndotreeToggle<CR>
...
" ==================== nvim-spectre ====================
nnoremap <LEADER>f <cmd> require('spectre').open()<CR>
vnoremap <LEADER>f <cmd> require('spectre').open_visual()<CR>
...
noremap <silent> = <Cmd>execute('normal! ' . v:count1 . 'n')<CR>
            \<Cmd> require('hlslens').start()<CR>
noremap <silent> - <Cmd>execute('normal! ' . v:count1 . 'N')<CR>
            \<Cmd> require('hlslens').start()<CR>
noremap * *<Cmd> require('hlslens').start()<CR>
noremap # #<Cmd> require('hlslens').start()<CR>
noremap g* g*<Cmd> require('hlslens').start()<CR>
noremap g# g#<Cmd> require('hlslens').start()<CR>
...
map <nowait> <leader>m <Plug>Lightspeed_omni_s
if g:nvim_plugins_installation_completed == 1
 lua <<EOF
